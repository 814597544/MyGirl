...
public class MyGirlActivity extends BaseActivity{
    ...
    private void initPicture() {
        mPicture_1 = getResources().getDrawable(R.drawable.now1);
        mPicture_2 = getResources().getDrawable(R.drawable.now2);
        mPicture_3 = getResources().getDrawable(R.drawable.now3);
    }
